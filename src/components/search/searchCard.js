    ...
    render() {
        return (
            <Card style={styles.post}>
                <CardItem style={styles.header}>
                    <Left>
                        <TouchableOpacity
                            ...
                            <Thumbnail
                                style={styles.avatar}
                                source={{ uri: `https://steemitimages.com/u/${this.props.content.author}/avatar/small` }}
                            />
                        </TouchableOpacity>
                        <Body style={styles.body}>
                            ...
                            <Text style={styles.timeAgo} note>
                                { '   ' +
                                    moment.utc(this.props.content.created_at)
                                    .local()
                                    .fromNow()
                                }
                            </Text>
                ...
                <Image
                    source={{ uri: this.props.content.img_url }}
                    ...
                    <CardItem>
                        <Body>
                            ...
                            <Text style={styles.summary}>
                                {postSummary(this.props.content.body, 100)}
                            </Text>
                        </Body>
                    </CardItem>
                </TouchableOpacity>
                ...
                <CardItem>
                    <Text style={styles.footer}>
                        {this.props.content.total_votes} likes
                    </Text>
                </CardItem>
            </Card>
        );
